...
- Codex Responses includes device-code OAuth login, refresh helpers, and a caller-wrapped token provider. Browser callback login, token persistence, and WebSocket transport are out of scope.
