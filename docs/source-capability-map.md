...
| Mistral Conversations | `mistral-conversations` | [provider/mistral](../provider/mistral) | Text adapter for Mistral Conversations streaming, thinking chunks, base64 image input, image-bearing tool results, session affinity, and tool-call deltas. |
