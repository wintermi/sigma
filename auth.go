...
const (
	...
	defaultBasetenAPIKeyEnv       = "BASETEN_API_KEY"
	...
	defaultQwenTokenPlanAPIKeyEnv = "QWEN_TOKEN_PLAN_API_KEY"
)
...
var defaultProviderEnvNames = map[ProviderID][]string{
	...
	ProviderBaseten:                 {defaultBasetenAPIKeyEnv},
	...
	ProviderQwenTokenPlan:           {defaultQwenTokenPlanAPIKeyEnv},
	ProviderQwenTokenPlanIndividual: {defaultQwenTokenPlanAPIKeyEnv},
